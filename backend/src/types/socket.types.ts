import { IIncident } from './incident.types'; // Changed from Incident to IIncident
...
export interface ServerToClientEvents {
  ...
  // Incident Events
  'new-incident': (incident: IIncident) => void; // Changed
  'incident-update': (incident: IIncident) => void; // Changed
...
export interface ClientToServerEvents {
  ...
  // Incident Events
  'report-incident': (data: Partial<IIncident>) => void; // Changed
